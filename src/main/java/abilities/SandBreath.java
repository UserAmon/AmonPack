...
public class SandBreath extends SandAbility implements AddonAbility {
    ...
    public int speedsand = AmonPackPlugin.plugin.getConfig().getInt("AmonPack.Earth.Sand.SandBreath.SpeedOnSand");
    public int speedearth = AmonPackPlugin.plugin.getConfig().getInt("AmonPack.Earth.Sand.SandBreath.SpeedOnEarth");
	...
	public Ability abi = this;
	public int usage;
	public int usagev2;
	public HashMap<String, Integer> taskID = new HashMap<String, Integer>();
	public HashMap<String, BukkitTask> deltask = new HashMap<String, BukkitTask>();
